...
$(function() {  
	...
	var options = {  
	    ...
	    xaxis: { 
	    	ticks: 
	    		[[1,"change_of_address"],[2,"change_of_name"],
	    		[3,"date_of_birth"],[4,"finished"],
	    		[5,"first_name"],[6,"has_mailing_address"],
	    		[7,"home_address"],[8,"home_zip_code"],
	    		[9,"id_number"],[10,"last_name"],
	    		[11,"mailing_address"], [12,"mailing_city"], 
	    		[13,"mailing_state"], [14,"mailing_zip_code"], 
	    		[15,"name_title"], [16,"opt_in_email"], 
	    		[17,"opt_in_sms"], [18,"party"], 
	    		[19,"phone"], [20,"phone_type"], 
	    		[21,"prev_address"], [22,"prev_city"], 
	    		[23,"prev_first_name"], [24,"prev_last_name"], 
	    		[25,"prev_name_title"], [26,"prev_state_id"], 
	    		[27,"prev_zip_code"],[28,"race"]]}
	};  
	
	//Lookup Table, specific to Rocky voter reg form fields
...
*/
  ...
  return outputarray;
	...
	var single_data_sort = SortArrayByKeys(progress_singlepage);
	var tabbed_data_sort = SortArrayByKeys(progress_tabs);
	var accord_data_sort = SortArrayByKeys(progress_accordion);
	...
	var single_data = getData(single_data_sort);
	var tabbed_data = getData(tabbed_data_sort);
	var accord_data = getData(accord_data_sort);
    ...
    $.plot( singlePlot , all_data, options )    
